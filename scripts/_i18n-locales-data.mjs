...
const locales = {
  es: {
    ...
    billing: {
      ...
      overLimit:
        "Tu clínica tiene {count} podólogos activos, por encima del plan en línea (hasta {limit}). Contacta a Podoraa para ampliar tu capacidad y la facturación.",
      loading: "Cargando…",
...
locales.en = {
  ...
  billing: {
    ...
    overLimit:
      "Your clinic has {count} active podiatrists, above the online plan (up to {limit}). Contact Podoraa to increase capacity and billing.",
    loading: "Loading…",
...
Object.assign(locales.pt.billing, {
  ...
  overLimit:
    "A sua clínica tem {count} podólogos ativos, acima do plano em linha (até {limit}). Contacte o Podoraa para ampliar a capacidade e a faturação.",
  loading: "A carregar…",
...
Object.assign(locales.fr.billing, {
  ...
  overLimit:
    "Votre clinique a {count} podologues actifs, au-dessus du forfait en ligne (jusqu'à {limit}). Contactez Podoraa pour augmenter la capacité et la facturation.",
  loading: "Chargement…",
