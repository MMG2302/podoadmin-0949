...
export function useSidebarNavItems() {
  ...
  const navItems = useMemo((): SidebarNavItem[] => {
    ...
    return [
      ...
      {
        path: "/billing",
        label: t.nav.billing ?? "Facturación",
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      {
        path: "/clinical-tools",
        label: t.nav.clinicalTools ?? "Herramientas clínicas",
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        label: t.nav.whatsappCampaigns ?? "Campañas WhatsApp",
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      },
      {
        ...
        label: t.nav.securityMetrics ?? "Métricas de seguridad",
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
