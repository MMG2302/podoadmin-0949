...
import accessEventsRoutes from './routes/access-events';
import { announcementsRoutes } from './routes/access-events';
...
app.use('/checkout-handoffs', requireActiveSubscription);
app.use('/checkout-handoffs/*', requireActiveSubscription);
...
app.route('/checkout-handoffs', checkoutHandoffsRoutes);
...
app.route('/access-events', accessEventsRoutes);
app.route('/location-announcements', announcementsRoutes);
