        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden">
          ...
          <div className="divide-y divide-gray-50 dark:divide-gray-800">
            {allUsers.slice(0, 5).map((u) => {
              ...
              return (
                <div key={u.id} className="p-4 flex items-center gap-3 sm:gap-4 min-w-0 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                  <div className="w-10 h-10 flex-shrink-0 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center">
                    <span className="font-medium text-[#1a1a1a] dark:text-white">
                      {u.name.charAt(0)}
                    </span>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-[#1a1a1a] dark:text-white truncate">{u.name}</p>
