...
const es: LandingI18n = {
  ...
  pricingPremium: {
    name: "Clínica",
    tagline: "Para equipos y clínicas que quieren crecer y medir.",
    price: "$100",
...
const en: LandingI18n = {
  ...
  pricingPremium: {
    name: "Clinic",
    tagline: "For teams and clinics that want to grow and measure.",
    price: "$100",
...
const pt: LandingI18n = {
  ...
  pricingPremium: {
    name: "Clínica",
    tagline: "Para equipas e clínicas que querem crescer e medir.",
    price: "$100",
    period: "/mês por clínica",
    cta: "Escolher Clínica",
    badge: "Recomendado",
    features: [
      "Tudo do plano Independente",
      "Até 8 podólogos",
...
const fr: LandingI18n = {
  ...
  pricingPremium: {
    name: "Clinique",
    tagline: "Pour les équipes et cliniques qui veulent croître et mesurer.",
    price: "$100",
