...
const es: LandingI18n = {
  ...
  solutionTime: {
    ...
    solution: "Agenda, historia clínica y cobro en un solo flujo, para que tu energía vaya a los pacientes y no al papeleo.",
  },
  solutionDecisions: {
  ...
  audienceClinicDesc: "Agrega podólogos y recepcionistas, gestiona suscripciones, checkout compartido, WhatsApp y la visión global del negocio.",
  ...
  pricingNote: "Prueba inicial sin tarjeta. Recordatorios de WhatsApp sin límites en todos los planes. Cancela cuando quieras. Precios en USD.",
  ctaTitle: "Empieza hoy y enfócate en tus pacientes",
  ctaSubtitle: "Regístrate en minutos y descubre lo fácil que es llevar tu consulta. Sin tarjeta para la prueba inicial.",
...
const en: LandingI18n = {
  ...
  solutionTime: {
    ...
    solution: "Scheduling, clinical records and billing in one flow, so your energy goes to your patients, not paperwork.",
  },
  solutionDecisions: {
  ...
  audienceClinicDesc: "Add podiatrists and receptionists, manage subscriptions, shared checkout, WhatsApp and business-wide visibility.",
  ...
  pricingNote: "Initial trial with no card. Unlimited WhatsApp reminders on every plan. Cancel anytime. Prices in USD.",
  ctaTitle: "Start today and focus on your patients",
  ctaSubtitle: "Sign up in minutes and see how easy running your practice can be. No card required for the initial trial.",
...
const pt: LandingI18n = {
  ...
  solutionTime: {
    ...
    solution: "Agenda, história clínica e cobrança num só fluxo, para que a sua energia vá para os pacientes e não para a papelada.",
  },
  solutionDecisions: {
  ...
  audienceClinicTitle: "Clínicas",
  audienceClinicDesc: "Adicione podólogos e rececionistas, gira subscrições, checkout partilhado, WhatsApp e a visão global do negócio.",
  ...
  pricingNote: "Período inicial sem cartão. Lembretes de WhatsApp sem limites em todos os planos. Cancele quando quiser. Preços em USD.",
  ctaTitle: "Comece hoje e concentre-se nos seus pacientes",
  ctaSubtitle: "Registe-se em minutos e veja como é fácil gerir a sua consulta. Sem cartão para o período inicial.",
...
const fr: LandingI18n = {
  ...
  solutionTime: {
    ...
    solution: "Agenda, dossier clinique et encaissement dans un seul flux : votre énergie va aux patients, pas à la paperasse.",
  },
  solutionDecisions: {
  ...
  audienceClinicDesc: "Ajoutez podologues et réceptionnistes, gérez abonnements, checkout partagé, WhatsApp et la vision globale de l'activité.",
  ...
  pricingNote: "Essai initial sans carte. Rappels WhatsApp illimités sur tous les plans. Annulez à tout moment. Prix en USD.",
  ctaTitle: "Commencez aujourd'hui et concentrez-vous sur vos patients",
  ctaSubtitle: "Inscrivez-vous en quelques minutes et découvrez à quel point gérer votre cabinet peut être simple. Sans carte pour l'essai initial.",
