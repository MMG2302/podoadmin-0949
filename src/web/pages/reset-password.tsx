...
const ResetPassword = () => {
  ...
  if (!token && error) {
    return (
      <div className="min-h-screen h-dvh bg-white overflow-y-auto overflow-scrolling-touch">
        <div className="flex min-h-full items-center justify-center p-8 pb-mobile-safe">
        <div className="max-w-md w-full text-center">
          ...
          <button
            ...
            className="w-full py-3 bg-brand-ink text-brand-ink-fg font-medium rounded-lg hover:bg-brand-ink-hover"
          >
            {t.auth.requestNewLink}
          </button>
          <button
            onClick={() => setLocation("/login")}
            className="w-full mt-3 py-3 bg-brand-canvas text-brand-ink font-medium rounded-lg hover:bg-gray-200"
          >
            {t.auth.backToLogin}
          </button>
        </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-4 py-3.5 pr-11 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:border-brand-ink focus:ring-1 focus:ring-brand-ink transition-all text-brand-ink bg-gray-50 dark:bg-gray-900 border-brand-border placeholder:text-gray-400 dark:placeholder:text-gray-500"
                        placeholder="••••••••"
                        required
                        minLength={12}
